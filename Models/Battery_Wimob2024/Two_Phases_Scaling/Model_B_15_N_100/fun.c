...
int a[NbArrivals] = {0, 1, 2};
int b[NbService] = {0, 1};
int c[NbRelease] = {0, 1};
int d[NbPhase] = {0, 1};


double pa[NbArrivals] = {0.2, 0.5, 0.3};           //proba of arrivals
double ps[2] ={0.0, 0.0};                          //Bernouilli service, will be initiated latter
double pr[2] ={0.0, 0.0};                          //Bernouilli release of Battery, will be initiated latter
...
void InitEvents(){
   ...
   ps[1] = (double)rand() / RAND_MAX; ps[0] = 1 - ps[1]; // Service probability
   pr[1] = (double)rand() / RAND_MAX; pr[0] = 1 - pr[1]; // Release probability
   printf("pService = %f \n", ps[1]);
   printf("pRelease = %f \n", pr[1]);
